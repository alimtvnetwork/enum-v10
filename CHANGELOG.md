...
## [v1.32.0] - 2026-05-10
### Changed — Module rename enum-v8 → enum-v10
- Bulk rename of `github.com/alimtvnetwork/enum-v8` → `github.com/alimtvnetwork/enum-v10` across `go.mod`, all Go source imports, spec docs, CI workflows, PowerShell tooling, and `.lovable/` memory.
...
## [v1.11.0] — 2026-05-07 — Module rename `enum-v7` → `enum-v10`

### Changed
- Bulk rename of module path and all references from `github.com/alimtvnetwork/enum-v7` to `github.com/alimtvnetwork/enum-v10` across `go.mod`, source, tests, specs, CI workflows, PowerShell tooling, and `.lovable/` memory.
...
## [v0.39.0] — 2026-05-07 — Cycle 67 — Bulk rename enum-v6 → enum-v10

### Changed
- Repository renamed from `enum-v6` to `enum-v10` per upstream rename. Bulk substitution applied across `go.mod`, Go source imports, all `spec/`, `.lovable/` memory files, workflows, and `cross-repo/core-v9/README.md` (one-time exception). `.release/`, `.git/`, and the `cross-repo/core-v9/` directory name preserved.
...
- **Cycle 19 spec audit (Task AB pass 1)** — upstream `core-v9 v1.5.8`
  ...
  (M-CVS-01: `enum-v3`→`enum-v10` module name; M-CVS-02: upstream `go.mod`
