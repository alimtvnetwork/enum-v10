...
- **Module path:** `github.com/alimtvnetwork/enum-v10` (renamed from `enum-v1`)
...
- `cross-repo/core-v9/` — mirror of a separate upstream repo. **Never** rename `core-v8` → `core-v9` here. **Never** rewrite `enum-v1` → `enum-v10` here.
