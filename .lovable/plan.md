...
- **Objective:** Update all `enum-v10` source files that use old `core-v8`-era function signatures (`converters.AnyToValueString`, `coredynamic.TypeName`, etc.) to the new struct-namespace API (`converters.AnyTo.ValueString`, `coredynamic.SafeTypeName`, etc.).
...
- **Status:** ✅ DONE (2026-05-07, Cycle 20, `spec-v0.55.0` / enum-v10 v0.70.0)
...
- **Status:** ✅ DONE (2026-05-10, Cycle 49, `spec-v0.57.0` / enum-v10 v1.26.0)
