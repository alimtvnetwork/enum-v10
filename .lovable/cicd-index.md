...
| 02 | [`cicd-issues/02-internal-package-rule.md`](./cicd-issues/02-internal-package-rule.md) | Go's `internal/` rule rejects consumers under `enum-v10/...` due to declared module path mismatch | ✅ Resolved — root cause (#01) fixed |
