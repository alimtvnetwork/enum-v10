...
|---|---|---|---|
| **M-CVS-01** | "This is a Go enum library (enum-v3, module path `github.com/alimtvnetwork/enum-v3`...)" | `go.mod` declares `module github.com/alimtvnetwork/enum-v10` | Memory line 4 corrected to `enum-v10`. |
